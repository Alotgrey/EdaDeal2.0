...
# Открываем файлы с продуктами
with open('MAGNIT.json', 'r', encoding='utf-8') as file1, open('PYATEROCHKA.json', 'r', encoding='utf-8') as file2:
    products1 = json.load(file1)
    products2 = json.load(file2)

# Функция для слияния продуктов
